...
Express API	/app\_api/routes, /app\_api/controllers	Responds to SPA requests
...
Verified it no longer appears and is deleted from API



Screenshots Submitted for Module 7

POST /api/register Successful User Registration

successful login test

Trip without token “Unauthorized access” test

Postman + Terminal  successful authenticated POST /api/trips request 
